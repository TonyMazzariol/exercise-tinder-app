...
console.log("Nombre de personnes qui gagnent plus de 2000$ :",                                      "create function".blue);
console.log("Nombre de personnes qui aiment les Drama :",                                           "create function".blue);
console.log("Nombre de femmes qui aiment la science-fiction :",                                     "create function".blue);
console.log(tr.line('LEVEL 2'));
console.log("Nombre de personnes qui aiment les documentaires et gagnent plus de 1482$ :",            "create function".blue);
console.log("Liste des noms, prénoms, id et revenu des personnes qui gagnent plus de 4000$ :",      "create function".blue);
console.log("Homme le plus riche (nom et id) :",                                                    "create function".blue);
console.log("Salaire moyen :",                                                                      "create function".blue);
console.log("Salaire médian :",                                                                     "create function".blue);
console.log("Nombre de personnes qui habitent dans l'hémisphère nord :",                             "create function".blue);
console.log("Salaire moyen des personnes qui habitent dans l'hémisphère sud :",                      "create function".blue);
console.log(tr.line('LEVEL 3'));            
console.log("Personne qui habite le plus près de Bérénice Cawt (nom et id) :",                      "create function".blue);
